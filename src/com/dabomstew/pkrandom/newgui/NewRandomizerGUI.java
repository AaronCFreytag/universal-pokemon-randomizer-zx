...
public class NewRandomizerGUI {
    ...
    private JCheckBox paBalanceBadAbilitiesCheckBox;
    ...
    public NewRandomizerGUI() {
        ...
        tpSimilarStrengthCheckBox.addActionListener(e -> enableOrDisableSubControls());
        ...
        tpNoDuplicatePokemon.addActionListener(e -> enableOrDisableSubControls());
        ...
        ptRandomAugmentedRadioButton.addActionListener(e -> enableOrDisableSubControls());
    ...
    private void restoreStateFromSettings(Settings settings) {
        ...
        peRandomizeSwapEvolutionMethods.setSelected(settings.isRandomizeEvolutionsWithSwap());
        ...
        paBalanceBadAbilitiesCheckBox.setSelected(settings.isBalanceBadAbilities());
        ...
        ptRandomAugmentedRadioButton.setSelected((settings.getTypesMod() == Settings.TypesMod.RANDOM_AUGMENTED));
        ...
        pmsSwapMovesLearnedWithCheckBox.setSelected(settings.isRandomizeMovesLearnedWithSwap());
        ...
        tpNoDuplicatePokemon.setSelected(settings.isTrainersNoDuplicatePokemon());
        tpBossBoost.setSelected(settings.isTrainerBossBoost());
    ...
    private Settings createSettingsFromState(CustomNamesSet customNames) {
        ...
        settings.setRandomizeEvolutionsWithSwap(peRandomizeSwapEvolutionMethods.isSelected());
        ...
        settings.setTypesMod(ptUnchangedRadioButton.isSelected(), ptRandomFollowEvolutionsRadioButton.isSelected(),
                ptRandomCompletelyRadioButton.isSelected(), ptRandomAugmentedRadioButton.isSelected());
        ...
        settings.setRandomizeMovesLearnedWithSwap(pmsSwapMovesLearnedWithCheckBox.isSelected());
        ...
        settings.setTrainersNoDuplicatePokemon(tpNoDuplicatePokemon.isSelected());
        settings.setTrainerBossBoost(tpSimilarStrengthCheckBox.isSelected() && tpBossBoost.isSelected());
    ...
    private void initialState() {
        ...
        ptRandomAugmentedRadioButton.setVisible(true);
        ptRandomAugmentedRadioButton.setEnabled(false);
        ptRandomAugmentedRadioButton.setSelected(false);
        ...
        paBalanceBadAbilitiesCheckBox.setVisible(true);
        paBalanceBadAbilitiesCheckBox.setEnabled(false);
        paBalanceBadAbilitiesCheckBox.setSelected(false);
        ...
        peRandomizeSwapEvolutionMethods.setVisible(true);
        peRandomizeSwapEvolutionMethods.setEnabled(false);
        peRandomizeSwapEvolutionMethods.setSelected(false);
        ...
        pmsSwapMovesLearnedWithCheckBox.setVisible(true);
        pmsSwapMovesLearnedWithCheckBox.setEnabled(false);
        pmsSwapMovesLearnedWithCheckBox.setSelected(false);
        ...
        tpNoDuplicatePokemon.setVisible(true);
        tpNoDuplicatePokemon.setEnabled(false);
        tpBossBoost.setVisible(true);
        tpBossBoost.setEnabled(false);
    ...
    private void romLoaded() {
        ...
        try {
            ...
            ptRandomAugmentedRadioButton.setEnabled(true);
...
//        peForceChangeCheckBox.setEnabled(true);
            ...
            peRandomizeSwapEvolutionMethods.setEnabled(true);
    ...
    private void enableOrDisableSubControls() {
        ...
        if (paRandomRadioButton.isSelected()) {
            ...
            paBalanceBadAbilitiesCheckBox.setEnabled(true);
        } else {
            paAllowWonderGuardCheckBox.setEnabled(false);
            paAllowWonderGuardCheckBox.setSelected(false);
            paFollowEvolutionsCheckBox.setEnabled(false);
        ...
        if (pmsMetronomeOnlyModeRadioButton.isSelected() || pmsUnchangedRadioButton.isSelected()) {
            ...
            pmsSwapMovesLearnedWithCheckBox.setEnabled(true);
        }
        ...
        if (tpUnchangedRadioButton.isSelected()) {
            ...
            tpAllowAlternateFormesCheckBox.setSelected(false);
            tpNoDuplicatePokemon.setEnabled(false);
            tpNoDuplicatePokemon.setSelected(false);
            tpBossBoost.setEnabled(false);
            tpBossBoost.setSelected(false);
            tpSwapMegaEvosCheckBox.setEnabled(false);
            tpSwapMegaEvosCheckBox.setSelected(false);
            tpRandomShinyTrainerPokemonCheckBox.setEnabled(false);
