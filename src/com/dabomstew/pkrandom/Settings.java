...
public class Settings {
    ...
    public enum TypesMod {
        UNCHANGED, RANDOM_FOLLOW_EVOLUTIONS, COMPLETELY_RANDOM, RANDOM_AUGMENTED
    }
    ...
    public static Settings fromString(String settingsString) throws UnsupportedEncodingException, IllegalArgumentException {
        ...
        settings.setRetainNumberOfAbilities(restoreState(data[49], 0));
        settings.setTrainersNoDuplicatePokemon(restoreState(data[49], 1));
        settings.setTrainerBossBoost(restoreState(data[49], 2));
        settings.setRandomizeMovesLearnedWithSwap(restoreState(data[49], 3));
        settings.setDevolveIllegalWildPokemon(restoreState(data[49], 4));
        settings.setDevolveIllegalStaticPokemon(restoreState(data[49], 5));
        settings.setBalanceBadAbilities(restoreState(data[49], 6));
